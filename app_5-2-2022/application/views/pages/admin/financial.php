        ...
        <form id="clientform">
          ...
          <table id="plSec_<?php echo $i; ?>" class="table hidePl" style="<?php if($pdata != NULL && (in_array( "pl" , $existing1 ) || in_array( "pl" , $existing2 )) ){ echo "display:block;"; } ?>">
            ...
            <tbody class="table-bordered">
              ...
              <tr>
                <td>Purpose</td>
                <td><input type="text" class="form-control" name="plpurpose_<?php echo $i-1; ?>" value="<?php echo $value["plpurpose_".($i-1)]; ?>"  placeholder="Type Purpose" style="text-transform: none!important;"></td>
                <td><input type="text" class="form-control" name="plpurpose_<?php echo $i; ?>" value="<?php echo $value["plpurpose_".$i]; ?>" placeholder="Type Purpose" style="text-transform: none!important;"></td>
              </tr>
          ...
          <?php }}else{ ?>
            <table class="table hidePl" style="<?php if($pdata != NULL && (in_array( "pl" , $existing1 ) || in_array( "pl" , $existing2 )) ){ echo "display:block;"; } ?>">
              ...
              <tbody class="table-bordered">
                ...
                <tr>
                  <td>Purpose</td>
                  <td><input type="text" class="form-control" name="plpurpose_1" placeholder="Type Purpose"  style="text-transform: none!important;"></td>
                  <td><input type="text" class="form-control" name="plpurpose_2" placeholder="Type Purpose"  style="text-transform: none!important;"></td>
                </tr>
  ...
  -->              </td>
          ...
          <table id="hpSec_<?php echo $i; ?>" class="table hideHp" style="<?php if($pdata != NULL && (in_array( "hp" , $existing1 ) || in_array( "hp" , $existing2 )) ){ echo "display:block;"; } ?>">
            ...
            <tbody class="table-bordered">
              ...
              <tr>
                <td>Purpose</td>
                <td><input type="text" name="hppurpose_<?php echo $i-1; ?>" value="<?php echo $value["hppurpose_".($i-1)]; ?>" class="form-control" placeholder="Type Purpose" style="text-transform: none!important;"></td>
                <td><input type="text" name="hppurpose_<?php echo $i; ?>" value="<?php echo $value["hppurpose_".$i]; ?>" class="form-control" placeholder="Type Purpose" style="text-transform: none!important;"></td>
              </tr>
          ...
          <?php }}else{ ?>
            <table class="table hideHp" style="<?php if($pdata != NULL && (in_array( "hp" , $existing1 ) || in_array( "hp" , $existing2 )) ){ echo "display:block;"; } ?>">
              ...
              <tbody class="table-bordered">
                ...
                <tr>
                  <td>Purpose</td>
                  <td><input type="text" name="hppurpose_1" class="form-control" placeholder="Type Purpose" style="text-transform: none!important;"></td>
                  <td><input type="text" name="hppurpose_2" class="form-control" placeholder="Type Purpose" style="text-transform: none!important;"></td>
                </tr>
...
<script>
  ...
  $('#addPersonalLoan').click(function(){
    ...
    if(plCount < 6){
      ...
      pLInc += '</center></td></tr><tr><td>Purpose</td><td><input type="text" class="form-control" name="plpurpose_'+(plCount - 1)+'" placeholder="Type Purpose" style="text-transform:none!important;"></td>';
      pLInc += '<td><input type="text" class="form-control" name="plpurpose_'+plCount+'"  placeholder="Type Purpose" style="text-transform:none!important;"></td></tr><tr><td>Start Date</td><td class="text-center">';
  ...
  $('#addHirePurchase').click(function(){
    ...
    if(hpCount < 6){
      ...
      pLInc += '</center></td></tr><tr><td>Purpose</td><td><input type="text" class="form-control" name="hppurpose_'+(hpCount - 1)+'" placeholder="Type Purpose" style="text-transform:none!important;"></td>';
      pLInc += '<td><input type="text" class="form-control" name="hppurpose_'+hpCount+'" placeholder="Type Purpose" style="text-transform:none!important;"></td></tr><tr><td>Start Date</td><td class="text-center">';
