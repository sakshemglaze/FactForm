<?php 
    ...
    $form_type = $this->admin->getFormDetails($_GET['data'], "form_detail")->form_type;
    $ftype = true;
    if($form_type == "single"){
        $ftype = false;
    }
    ...
    <div class="row">
        <div class="index-section center-block">
            ...
            <form id="clientform">
                ...
                <table border="1" cellpadding="0" cellspacing="0" class="table">
                    ...
                    <tbody class="table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle!important;">
                                <span><?php if($dob2 && $dob2_data[0] != "undefined"){echo $dob2_data[0];} ?></span> / <span><?php if($dob2 && $dob2_data[1] != "undefined"){echo $dob2_data[1];} ?></span> / <span><?php if($dob2 && $dob2_data[2] != "undefined"){echo $dob2_data[2];} ?></span>
                            </td>
                        </tr>
                    ...
                    <tbody class="table-bordered">                    
                        <tr>
                            ...
                            <td class="text-center">
                                <span><?php if($cdate1 && $cdate1_data[0] != "undefined"){echo $cdate1_data[0];} ?></span> / <span><?php if($cdate1 && $cdate1_data[1] != "undefined"){echo $cdate1_data[1];} ?></span> / <span><?php if($cdate1 && $cdate1_data[2] != "undefined"){echo $cdate1_data[2];} ?></span>
                            </td>
                            <td class="text-center">
                                <span><?php if($cdate2 && $cdate2_data[0] != "undefined"){echo $cdate2_data[0];} ?></span> / <span><?php if($cdate2 && $cdate2_data[0] != "undefined"){echo $cdate2_data[1];} ?></span> / <span><?php if($cdate2 && $cdate2_data[0] != "undefined"){echo $cdate2_data[2];} ?></span>
                            </td>
                        </tr>
                ...
                <table border="1" cellpadding="0" cellspacing="0" class="table less-3" style="margin-bottom: 10px !important;">
                    <thead class="">
                        <tr>
                            <th scope="col" style="border:0px;background-color:transparent;"></th>
                    ...
                    <tbody class="table-bordered">
                        <tr>
                            ...
                            <td class="" style="padding:0px 5px!important;"><?php if(isset($value["client_prevaddress".$i."_2"])){ echo $value["client_prevaddress".$i."_2"]; }else{ echo ""; } ?></td>
                        </tr>

                        <tr>
                        <td class="first-one">Postcode</td>
                            <td class="" style="padding:0px 5px!important;"><?php echo $value["client_prevpostcode".$i."_1"]; ?></td>
                            <td class="" style="padding:0px 5px!important;"><?php if(isset($value["client_prevpostcode".$i."_2"])){echo $value["client_prevpostcode".$i."_2"];} ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="col-md-2 date-input-box" style="padding: 0;margin-left: 30%;">
                                    <label class="form-check-label" for="">Yes</label>
                                    <?php if(isset($value["client_prelectoralRoll".$i."_1"]) && $value["client_prelectoralRoll".$i."_1"]=="Yes"){ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/tick-box.jpg" />
                                    <?php }else{ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    <?php } ?>
                                ...
                                <div class="col-md-2 date-input-box" style="padding: 0;">
                                    <label class="form-check-label" for="">No</label>
                                    <?php if(isset($value["client_prelectoralRoll".$i."_1"]) && $value["client_prelectoralRoll".$i."_1"]=="No"){ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/tick-box.jpg" />
                                    <?php }else{ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    <?php } ?>
                            ...
                            <td class="text-center">
                                <div class="col-md-2 date-input-box" style="padding: 0;margin-left: 30%;">
                                    <label class="form-check-label" for="">Yes</label>
                                    <?php if(isset($value["client_prelectoralRoll".$i."_2"]) && $value["client_prelectoralRoll".$i."_2"]=="Yes"){ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/tick-box.jpg" />
                                    <?php }else{ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    <?php } ?>
                                ...
                                <div class="col-md-2 date-input-box" style="padding: 0;">
                                    <label class="form-check-label" for="">No</label>
                                    <?php if(isset($value["client_prelectoralRoll".$i."_2"]) && $value["client_prelectoralRoll".$i."_2"]=="No"){ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/tick-box.jpg" />
                                    <?php }else{ ?>
                                        <img class="check-img" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    <?php } ?>
                ...
                <table border="1" cellpadding="0" cellspacing="0" class="tab-child" style="width: 100%;">
                    <thead class="">
                        <tr>
