<div class="pdf-container">
    <div class="row">
      <div class="index-section center-block" style="margin-top: 20px!important;">
        ...
        <h5 style="margin-bottom: 10px!important;">2.1 Employment Details</h5>
        ...
        <form id="clientform">
            ...
            <!--========FORM SUB-SECTION HEADING==========-->
            <h5 class="">2.2 Employment Details</h5>
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2">
              <thead class="">
                <tr>
                  <th scope="col" style="border:0px;background-color:transparent;"></th>
              ...
              <tbody class="table-bordered">
                ...
                <tr>
                  ...
                  <td class="condition_client_1"></td>
                  <td class="condition_client_2"></td>  
                </tr>
            ...
            <!-- TABLE 1 START HERE-->
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2" style="margin-top:10px; margin-bottom: 0px!important;">
              <thead class="">
                <tr>
                  <th scope="col" style="border:0px;background-color:transparent;"></th>
                  <th scope="col" class="condition_client_1">Client 1</th>
            ...
            <!-- TABLE 2 STARTS HERE-->
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2" style="margin-top: 2px;">
              <tbody class="table-bordered">
                <tr>
                ...
                <tr>
                  <td class="first-one">Overtime (regular)</td>
                  <td class="condition_client_1">
                ...
                <tr>
                  <td class="first-one">Shift Allowance (regular)</td>
                  <td class="condition_client_1">
            ...
            <!-- TABLE 3 STARTS HERE-->
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2" style="margin-top: 10px;">
              <tbody class="table-bordered">
                <tr>
                  <td class="first-one" style="width:25%!important;">Other Earned Income <br/><span style="font-weight:normal;">(e.g. 2nd Job – provide details Notes)</span></td>
                  <td class="condition_client_1">
                    <span style="margin:0px 5px;">£</span>
            ...
            <!-- TABLE 4 STARTS HERE -->
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2"  style="margin-top: 10px; margin-bottom: 20px!important;">
              <tbody class="table-bordered" style="border:2px solid #000000;">
                <tr>
                  ...
                  <td class="condition_client_2" style="font-weight: bold;">
            ...
            <!-- TABLE 1 STARTS HERE -->
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2" style="margin-top: 10px!important;">
              <thead class="">
                <tr>
                  <th scope="col" style="border:0px;background-color:transparent;"></th>
                  <th scope="col" class="condition_client_1">Client 1</th>
            ...
            <!-- TABLE 2 STARTS HERE -->
            <table border="1" cellpadding="0" cellspacing="0" class="table condition-2"  style="margin-top: 10px; margin-bottom: 15px!important;">
              <tbody class="table-bordered" style="border:2px solid #000000;">
                <tr>
                  ...
                  <td class="condition_client_2" style="font-weight: bold!important;">
                     <span style="margin:0px 5px;">£</span>
