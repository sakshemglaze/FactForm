    ...
    <div class="row">
        ...
        <form id="clientform">
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="table" style="margin-top: 10px!important;">
                <tbody class="table-bordered">
                    <tr>
                        <td class="first-one" style="width: 15%;">Solicitor</td>
                        <td></td>
                    </tr>

                    <tr>
                        <td class="first-one" style="width: 15%;">Address</td>
                        <td></td>
                    </tr>

                    <tr>
                       <td class="first-one" style="width: 15%;">Postcode</td>
                       <td></td>
                    </tr>

                    <tr>
                        <td class="first-one" style="width: 15%;">Contact Name</td>
                        <td></td>
                    </tr>

                    <tr>
                        <td class="first-one" style="width: 15%;">Contact Telephone</td>
                        <td></td>
                    </tr>

                    <tr>
                        <td class="first-one" style="width: 15%;">Contact Email</td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="table" style="margin-top: 10px!important;">
                <tbody class="table-bordered">
                    <tr>
                        <td class="first-one" style="width: 15%;">Estate Agent</td>
                        <td></td>
                    </tr>
