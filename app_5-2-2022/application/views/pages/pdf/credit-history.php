...
<div class="pdf-container">
    <div class="row">
        ...
        <form id="clientform">
            ...
            <!--TABLE 1 STARTS HERE-->
            <table class="table" style="margin-top: 30px!important;" border="1" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
            ...
            <!--TABLE 2 STARTS HERE-->
                <table class="table" style="margin-top: 10px!important; margin-bottom: 10px!important;" border="1" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                            <th scope="col" style="border:0px;background-color:transparent;"></th>
