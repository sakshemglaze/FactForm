...
<div class="pdf-container">
    <div class="row">
        <div class="index-section center-block">
           ...
           <h5 style="margin-bottom: 0px!important;">1.1 Personal Details</h5>
            ...
            <table class="table">
                ...
                <tbody class="table-bordered">
                            ...
                            <ul class="title-list">
                                ...
                                <li>
                                   ...
                                   <!--  <?php if($client_title_1 == "Miss"){ ?>
                                        <img class="check-img" src="<?php echo base_url(); ?>assets/images/tick-box.jpg" />
                                    <?php } else{ ?> -->
                                        <img class="check-img" style="position:relative;margin-left: 14px; margin-top: 2px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                   <!--  <?php }?> -->
                                    </span>
                                </li>
                                 ...
                                 <li>
                                    ...
                                    <!-- <?php if($client_title_1 == "Dr"){ ?>
                                        <img class="check-img" src="<?php echo base_url(); ?>assets/images/tick-box.jpg" />
                                    <?php } else{ ?> -->
                                        <img class="check-img" style="margin-left: 6px; margin-top: 2px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    <!-- <?php }?> -->
                                    </span>
                                </li>
                                ...
                                <li>
                                    ...
                                    <!-- <?php if($client_title_1 == "Prof"){ ?>
                                        <img class="check-img" src="<?php echo base_url(); ?>assets/images/tick-box.jpg" />
                                    <?php } else{ ?> -->
                                        <img class="check-img" style="margin-left: 7px; margin-top: 2px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    <!-- <?php }?> -->
                                    </span>
                                </li>
                                ...
                                <li style="width: 100%;display: block;">
                                    <span>
                                        <label class="form-check-label" for="defaultCheck1" style="margin-left: -20px;">Other</label>
                                    <!-- <?php if($client_title_1 == "Other"){ ?>
                                        <img class="check-img" src="<?php echo base_url(); ?>assets/images/tick-box.jpg" />
                                    <?php } else{ ?> -->
                                        <img class="check-img" style="margin-left: 10px; margin-top: 2px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" /> : 
                                    <!-- <?php }?> -->
                                    </span>
                                </li>                                                          
                            </ul>
                    ...
                    <tr>
                        <td class="first-one" style="padding: 1.55em 0.85em;line-height: 1.85em;">Current Address</td>
                        <td>
                    ...
                    <tr>
                        <td class="first-one" style="padding: 0.45em;line-height: 1.85em;">Email Address</td>
                        <td>
                    ...
                    <tr>
                            ...
                            <td style="padding-top: 2px; padding-bottom: 2px;">
                                ...
                                <div>
                                    <label class="form-check-label" for="contactCheck4">Other :</label>
                                    <span class="form-check">
                                        <img class="check-img" style="position: relative;margin-top: -16px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    </span>
                                </div>
                            </td>
                ...
                <span class="less-3" style="margin-bottom: 10px!important; font-size: 8pt;">If you have lived at your current address for less than three years, please complete this section.</span>

                <!--=====1.3 PREVIOUS RESIDENCE TABLESTARTS HERE=====-->
                
                <!--PREVIOUS ADDRESS 1 TABLE -->
                <table class="table less-3" style="margin-top: 10px!important;">
                    <thead class="">
                        <tr>
                            <th scope="col" style="border:0px;background-color:transparent;"></th>
                    ...
                    <tbody class="table-bordered">
                        <tr>
                            <td class="first-one" style="padding: 1.25em 0.85em;line-height: 1.85em;">Previous Address 1</td>
                            <td class=""></td>
                            <td class=""></td>
                        </tr>
                ...
                <table class="table less-3" style="margin-top:10px!important;margin-bottom: 10px !important;">
                    <thead class="">
                        <tr>
                            <th scope="col" style="border:0px;background-color:transparent;"></th>
                            <th scope="col" class="hideclient_1">Client 1</th>
                    ...
                    <tbody class="table-bordered">
                        <tr>
                            <td class="first-one" style="padding: 1.25em 0.85em;line-height: 1.85em;">Previous Address 2</td>
                            <td class=""></td>
                            <td class=""></td>
                        </tr>
                ...
                <!--========FORM SUB-SECTION HEADING==========-->
                <h5 class="">1.4 Children & Dependants</h5>
                ...
                <table class="tab-child" style="width: 100%;">
                    <thead class="">
                        <tr>
                            ...
                            <th scope="col" style="width: 22%;">Dependent Upon</th>
                    ...
                    <tbody class="table-bordered" id="child_dependent">
                        <tr>
                            ...
                            <td class="text-center">
                                <center>
                                    <span>
                                        <label class="form-check-label" for="" style="font-size: 8pt!important;">Y</label>
                                        <img class="check-img float-none" style="margin-top: 5px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    </span>
                                    <span>
                                        <label class="form-check-label" for="" style="font-size: 8pt!important;">N</label>
                                        <img class="check-img float-none" style="margin-top: 5px;" src="<?php echo getcwd(); ?>/assets/images/blank-box.jpg" />
                                    </span>                                    
                                </center>                                
                            </td>
                ...
                <!--========FORM SUB-SECTION HEADING==========-->
              <h5 class="" style="margin-top: 10px!important;margin-bottom: 0px!important;">1.5 Health Details</h5>
              ...
              <!--========FORM SUB-SECTION HEADING==========-->
              <h5 class="" style="margin-top: 10px!important;margin-bottom: 0px!important;">1.6 Religious Details</h5>
...
<!--====================BOTTOM PAGE NO> AND RIGHT SIDE ALIGN TEXT CODE========================-->
