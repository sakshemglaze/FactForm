...
<div class="pdf-container">
    <div class="row">
      <div class="index-section center-block" style="margin-top: 20px!important;">   
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tab-child" style="width: 100%; margin-top: 20px!important;">
            <thead>
              <tr>
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="tab-child" style="width: 100%; margin-top: 20px!important;">
          ...
          <table border="1" cellpadding="0" cellspacing="0" class="tab-child" style="width: 100%; margin-top: 0px!important;">
            <thead>
              <tr>
                <th scope="col" style="border:0px;background-color:transparent;"></th>
                <th scope="col" style="width: 40%;">Signature</th>
