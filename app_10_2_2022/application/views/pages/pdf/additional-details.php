...
<div class="pdf-container">
    <div class="row">
        ...
        <form id="clientform">
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="tab-child" style="margin-top: 10px!important;width:100%!important;">
                <tbody class="">
                    <tr>
                ...
                <table border="1" cellpadding="0" cellspacing="0" class="table" style="margin-top: 20px!important;">
                    ...
                    <tbody class="table-bordered">
                        <tr>
                            ...
                            <td style="padding: 0px 5px;"><?php  if($ftype){  echo $value["previous_contract_name_".$i."_2"]; } ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="margin:0px 5px;">£</span>
                                <span><?php if($ftype){ echo $value["previous_contract_rate_".$i."_2"]; } ?></span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="margin: 0px 5px;"></span>
                                <span><?php if($ftype){ echo $value["previous_contract_days_".$i."_2"]; } ?> per week</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
