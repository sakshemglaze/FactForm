<style type="text/css">
  ...
  <div class="content-wrapper">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php if($this->session->userdata('type') == "admin"){
                   $getAllForms = $this->client->getAllForms();
                  }
                  elseif($this->session->userdata('type') == "client" || $this->session->userdata('type') == "subadmin"){
                    $getAllForms = $this->admin->getAllFormsByClientID($this->session->userdata('id'));
                  }
                  ...
                  <?php foreach ($getAllForms['result'] as $client) { $i++; ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button id="updatestatus_<?php echo $client->form_id; ?>" type="button" class="btn btn-primary btn-update" data-toggle="tooltip" data-placement="top" title="Complete">
    ...
    $('.btn-update').click(function(){
      ...
      formid = formid.split('_')[1];
      $.ajax({
        url:'<?php echo base_url(); ?>update/changeformstatus',
        type:'POST',
        data: {status: '1', id: formid},
        dataType:'json',
        success:function(as){
