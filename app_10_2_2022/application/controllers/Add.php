<?php
    ...
    class Add extends CI_Controller{
        ...
        public function clientRegistration(){
            ...
            $mail_html = '<!DOCTYPE html> <html><head><title></title>
                <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet">
            </head>
            <body style="background-color: #f1f1f1;font-family: "Source Sans Pro", sans-serif; padding: 113px 0px;">
                <table style="background-color: #ffffff; width: 500px; margin:0px auto; border-top: 6px solid #7ce5e9; border-bottom: 6px solid #7ce5e9; padding: 10px 15px;">
                    <tr>
                        <td>
                            <div><img src="'.base_url().'assets/img/logo.jpg" style="float: right;"></div>     			
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div style="text-align: justify;">
                                <h4 style="color: #333333; font-weight: normal; font-size: 18px;margin-bottom: 10px;">
                                    Hi <span style="color: #000000; font-weight: bold;"> '.$_POST['name'].'</span>,
                                </h4>
            
                                <p style="font-size: 16px; color: #333333;margin-top: 5px; margin-bottom: 5px;">
                                    Your find fact application form link and it’s login details are mentioned below : 
                                </p>
            
                                <a style="font-size: 15px;" href="'.base_url().'login">'.base_url().'login</a>
            
                                <p style="margin-bottom: 5px; margin-top: 10px; font-size: 16px; color: #000000; margin-left: 20px;font-weight: bold;">
                                    Email Id : <span style="font-weight: normal; color: #333333">'.$_POST['email'].'</span>
                                </p>
                                <p style="margin-bottom: 5px; margin-top: 10px; font-size: 16px; color: #000000; margin-left: 20px;font-weight: bold;">
                                    Password : <span style="font-weight: normal; color: #333333">'.$_POST['password'].'</span>
                                </p>
                            </div>
                            <div>
                                <p style="font-size: 16px;color: #333333;margin: 20px 0px 0px;">Regards,</p>
                                <h4 style="color: #333333; font-size: 16px;margin-bottom: 0px;margin-top: 0px;">Vipul Aggarwal</h4>
                                <span style="font-size: 14px; color: #333333;">Mortgage and Protection Adviser</span><br/>
                                    <span style="font-size: 14px; color: #333333;">Email id: vipul@optimalima.com</span><br/>
                                    <span style="font-size: 14px; color: #333333;">0333 370 1777 (T),<br/>07759 919700 (M)</span>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            if($this->session->userdata('type') == "subadmin"){
                $_POST['added_by'] = $this->session->userdata('id');
            }
            ...
            if($this->admin->registerClient($_POST)){
                ...
                // $headers = "From: noreply@greenerstyle.co.uk". "\r\n" .
                ...
                $mail = mail($_POST['email'],"Login Details - ".$_POST['name'],$mail_html, $headers);
                
                if(!$mail) {   
                    echo json_encode(['status'=> true, 'message' => "Error ! User added but error occured while sending mail"]);   
                } else {
                    
                    echo json_encode(['status'=> true, 'message' => "User added & Mail successfully sent to the user with their login details"]);
                }
            }
        }
